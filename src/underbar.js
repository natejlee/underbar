    ...
    var result = array.slice();
      for(var index = 0; index < array.length; index++){
        for(var inner = index + 1; inner < array.length; inner++){
            if(result[index] === result[inner]){
                result.splice(inner, 1);   
            }
        }
      }
      return result;
    ...
    // TIP: Try re-using reduce() here.
        ...
        return _.reduce(collection, function(first, second){
            if(typeof iterator === 'function'){
                return Boolean(first && iterator(second));   
            } else {
      ...
      return function(pos){
          if(pos in memo){
           return memo[pos];   
            ...
            memo[pos] = func.apply(this, arguments);
             return memo[pos];
          }
  ...
  _.shuffle = function(array) {
     ...
     var newArray = array.slice();
      ...
      for(var index = newArray.length; index > 0; index--){
          ...
          var pos = newArray.splice(rand,1)[0];
